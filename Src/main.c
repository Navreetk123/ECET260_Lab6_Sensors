...
int main(void)
{
  ...
  GUI_DispStringAt("Temperature: ", 10, 10);
  GUI_DispFloat(TempVal, 5);
  //GUI_DispCharAt('°',300,10);
  GUI_DispString("°C");
  GUI_DispStringAt("Pressure: ", 10, 50);
  GUI_DispFloat(PVal, 5);
  GUI_DispString("kPa");
  GUI_DispStringAt("Humidity: ", 10, 90);
  GUI_DispFloat(HVal, 5);
  GUI_DispChar('%');
  GUI_Exec();
  GUI_TOUCH_Exec();
  }
